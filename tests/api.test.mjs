...
test('a land listing publishes on a sale method alone, but a private sale still needs a price or a label',async t=>{const{staff}=await fixture(t);const media=[{url:'/assets/land-cedar-ridge.webp',alt:'A'},{url:'/assets/land-orchard-lane-supplied.webp',alt:'B'},{url:'/assets/land-mill-street.webp',alt:'C'}];const base={title:'Tender Lot',sector:'land',property_type:'development_site',price_minor:0,price_label:'',currency:'AUD',bedrooms:0,bathrooms:0,parking:0,locality:'Nowhere',summary:'S',description:'D',publication_state:'published',transaction_status:'available',media,features:[],details:[],highlights:[],floor_area:0,land_area:900,zoning:'Mixed use',tenancy:''};
