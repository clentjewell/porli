...
serif, the mark and tile as SVG, screenshots of the live surfaces in `public/img/`, and a PDF of
the whole document. No script, no database, no third-party requests.
