  ...
  return `<div class="market-home">
    ...
    <section class="market-destinations market-width" data-reveal aria-label="Featured destinations">
      ...
      <div class="destination-grid" data-reveal-group>
        <a class="destination-card" data-reveal href="/properties?sector=land&location=Saltmere"><img src="/assets/land-mill-street.webp" alt="A fictional cleared corner development site at Saltmere — generated concept image" loading="lazy" width="1536" height="1032"><span class="destination-scrim" aria-hidden="true"></span><span class="destination-body"><strong>Saltmere</strong><em>Coastal sites and acreage.</em><span class="destination-facts">${esc(profile('Saltmere','land'))}</span></span><span class="destination-arrow" aria-hidden="true">${icon('external')}</span></a>
    ...
    <section class="market-service" aria-labelledby="service-heading">
      <div class="service-split">
        <div class="service-photo"><img src="/assets/land-orchard-lane.webp" alt="A fictional subdivision site with surveyed lots and a new road. Generated concept image." loading="lazy" width="1536" height="1032"></div>
