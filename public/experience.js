  ...
  return `<div class="market-home">
    ...
    <section class="market-destinations market-width" data-reveal aria-label="Featured destinations">
      ...
      <div class="destination-grid" data-reveal-group>
        <a class="destination-card" data-reveal href="/properties?sector=land&location=Saltmere"><img src="/assets/land-harbour-road.webp" alt="Paddocks beside a sealed road, an openly licensed photograph of a real place standing in for fictional Saltmere" loading="lazy" width="1536" height="1032"><span class="destination-scrim" aria-hidden="true"></span><span class="destination-body"><strong>Saltmere</strong><em>Coastal sites and acreage.</em><span class="destination-facts">${esc(profile('Saltmere','land'))}</span></span><span class="destination-arrow" aria-hidden="true">${icon('external')}</span></a>
