...
| D026 | Proposed | An editorial front page format is built at /editorial and served beside the existing homepage (docs/31), opening full-screen on GrandBlue with the property name as the page h1 and reading down as one piece rather than a stack of modules. Additive: nothing on / changes and nothing links to it. Adopting, dropping or merging the two is Clent's call | Clent, 21 September 2026 |
