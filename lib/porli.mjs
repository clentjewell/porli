...
export function createPorli({ db, files, schema, fixture, demo = false, seed = demo, adminEmail = '', adminPassword = '', mapsEmbedKey = '' }) {
  ...
  if (seed) {
    const landFixtures = [
      ...
      { id:'demo-land-05', slug:'cedar-ridge', plan:'plan-cedar-ridge', title:'Cedar Ridge', property_type:'rural', locality:'Elmshore', land_area:420000, zoning:'Rural (fictional)', sale_method:'private_sale', price_minor:240000000, price_label:'', status:'available', state:'published', image:'land-cedar-ridge', aerial:'aerial-cedar-ridge',
        summary:'Forty-two hectares of grazing country with a ridge-top house site.',
        description:'Cedar Ridge is 42 hectares of undulating grazing land on Ridge Road, fenced into four paddocks with a dam in each. A cleared ridge-top site has views across the valley and power at the road. Two road frontages.\n\nRural zoning; a dwelling is permitted subject to approval. Offered for private sale. This is a fictional listing, illustrated with openly licensed photographs of real places elsewhere.',
