...
export function createPorli({ db, files, schema, fixture, demo = false, seed = demo, adminEmail = '', adminPassword = '', mapsEmbedKey = '' }) {
  ...
  if (seed) {
    const landFixtures = [
      ...
      { id:'demo-land-05', slug:'cedar-ridge', plan:'plan-cedar-ridge', title:'Cedar Ridge', property_type:'rural', locality:'Elmshore', land_area:420000, zoning:'Rural (fictional)', sale_method:'private_sale', price_minor:240000000, price_label:'', status:'available', state:'published', image:'land-cedar-ridge-supplied', aerial:'aerial-cedar-ridge',
        summary:'Forty-two hectares of grazing country with a ridge-top house site.',
        description:'Cedar Ridge is 42 hectares of undulating grazing land on Ridge Road, fenced into four paddocks with a dam in each. A cleared ridge-top site has views across the valley and power at the road. Two road frontages.\n\nRural zoning; a dwelling is permitted subject to approval. Offered for private sale. This is a fictional listing, illustrated with photographs of real places elsewhere: a reference photograph supplied by the RealDistrict team and an openly licensed aerial.',
    ...
    const LAND_CREDITS = {"land-elmshore-heights": {"credit": "Photo: Philip Mallis, CC BY-SA 2.0, Wikimedia Commons", "place": "Keilor East, Victoria"}, "aerial-saltmere-valley": {"credit": "Aerial: Bauple58, CC BY-SA 4.0, Wikimedia Commons", "place": "Barellan, New South Wales"}, "aerial-cedar-ridge": {"credit": "Aerial: Nick Pitsas, CSIRO, CC BY 3.0, Wikimedia Commons", "place": "the Murrumbidgee near Murrumbateman, NSW"}, "land-cedar-ridge": {"credit": "Photo: Thennicke, CC BY-SA 4.0, Wikimedia Commons", "place": "Holbrook, New South Wales"}, "land-saltmere-valley": {"credit": "Photo: Shiftchange, CC0, Wikimedia Commons", "place": "Hillview, Queensland"}, "land-mill-street": {"credit": "Photo: Shiftchange, CC0, Wikimedia Commons", "place": "Lamington, Queensland"}, "land-harbour-road": {"credit": "Photo: Shiftchange, CC0, Wikimedia Commons", "place": "Mundoolun, Queensland"}, "land-fernwick-lot-12": {"credit": "Photo: Shiftchange, CC0, Wikimedia Commons", "place": "Carole Park, Queensland"}, "aerial-elmshore-heights": {"credit": "Aerial: Wikideas1, CC0, Wikimedia Commons", "place": "a subdivision under construction"}, "land-elmshore-gateway": {"credit": "Photo: Bob T, CC BY-SA 4.0, Wikimedia Commons", "place": "Williams Landing, Victoria"}, "land-orchard-lane-supplied": {"credit": "Reference photograph supplied by the RealDistrict team", "place": "a real housing estate elsewhere", "kind": "supplied"}, "aerial-orchard-lane-supplied": {"credit": "Reference photograph supplied by the RealDistrict team", "place": "a real housing estate elsewhere", "kind": "supplied"}, "land-saltmere-valley-supplied": {"credit": "Reference photograph supplied by the RealDistrict team", "place": "real farmland elsewhere", "kind": "supplied"}, "aerial-saltmere-valley-supplied": {"credit": "Reference photograph supplied by the RealDistrict team", "place": "real farmland elsewhere", "kind": "supplied"}, "land-cedar-ridge-supplied": {"credit": "Reference photograph supplied by the RealDistrict team", "place": "a real lakeside estate elsewhere", "kind": "supplied"}};
    // A fourth kind (docs/62): a reference photograph the team supplied, of a real place elsewhere.
    const kindText = k => LAND_CREDITS[k].kind === 'supplied' ? 'Reference photograph supplied by the team.' : 'Openly licensed photograph.';
    const landMedia = f => [{ url:`/assets/${f.image}.webp`, alt:`${f.title}: photograph of a real place (${LAND_CREDITS[f.image].place}), used to illustrate this fictional listing. ${kindText(f.image)}`, caption:LAND_CREDITS[f.image].credit }];
    const landPlans = f => [{ kind:'site_plan', url:`/assets/${f.plan}.webp`, alt:`${f.title}: illustrative site plan of a fictional parcel, not a survey. Generated concept image.`, caption:'Illustrative site plan, not a survey' }, ...(f.aerial?[{ kind:'aerial', url:`/assets/${f.aerial}.webp`, alt:`Aerial photograph of a real place (${LAND_CREDITS[f.aerial].place}), standing in for ${f.title}. ${kindText(f.aerial)}`, caption:LAND_CREDITS[f.aerial].credit }]:[]) ];
