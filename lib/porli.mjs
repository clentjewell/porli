...
export function createPorli({ db, files, schema, fixture, demo = false, seed = demo, adminEmail = '', adminPassword = '', mapsEmbedKey = '' }) {
  ...
  if (seed) {
    const landFixtures = [
      { id:'demo-land-01', slug:'harbour-road-development-site', title:'Harbour Road Development Site', property_type:'development_site', locality:'Saltmere', land_area:2450, zoning:'Mixed use (fictional)', sale_method:'expressions_of_interest', price_minor:0, price_label:'', status:'available', state:'published', image:'land-mill-street',
        summary:'A level corner site with two frontages, a short walk from the harbour.',
        description:'Harbour Road Development Site is a 2,450 m² corner parcel with 48 metres of frontage to Harbour Road and a second frontage to the lane behind. The site is level and cleared, with water, sewer and power at the boundary and an existing crossover.\n\nMixed-use zoning allows shops or offices at street level with apartments above, subject to approval. Offered by expressions of interest. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-02', slug:'mill-street-corner', title:'Mill Street Corner', property_type:'development_site', locality:'Fernwick', land_area:1180, zoning:'Residential growth (fictional)', sale_method:'auction', price_minor:0, price_label:'', status:'sold', state:'published', image:'land-mill-street',
        summary:'A compact corner block in the town centre, sold at auction.',
        description:'Mill Street Corner is an 1,180 m² corner block at the edge of the Fernwick town centre, zoned for medium-density housing. Sold at auction. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-03', slug:'fernwick-estate-lot-12', title:'Fernwick Estate, Lot 12', property_type:'commercial_industrial', locality:'Fernwick', land_area:4800, zoning:'General industrial (fictional)', sale_method:'private_sale', price_minor:165000000, price_label:'', status:'available', state:'published', image:'land-fernwick-lot-12',
        summary:'A serviced industrial lot on a sealed estate road, ready to build.',
        description:'Lot 12 is a 4,800 m² rectangular lot on Estate Drive within the Fernwick business estate. The lot is benched and compacted, with all services connected at the boundary and a sealed road frontage of 80 metres.\n\nGeneral industrial zoning suits warehousing, light manufacturing and depots, subject to approval. Offered for private sale. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-04', slug:'elmshore-gateway-lot-3', title:'Elmshore Gateway, Lot 3', property_type:'commercial_industrial', locality:'Elmshore', land_area:9200, zoning:'Light industrial (fictional)', sale_method:'expressions_of_interest', price_minor:0, price_label:'', status:'under_offer', state:'published', image:'land-elmshore-gateway',
        summary:'A large light-industrial lot with highway exposure, now under offer.',
        description:'Lot 3 at Elmshore Gateway is a 9,200 m² lot with 115 metres of frontage to Gateway Boulevard and exposure to the highway beyond. Light industrial zoning suits showrooms, trade supplies and logistics, subject to approval.\n\nOffered by expressions of interest and currently under offer. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-05', slug:'cedar-ridge', title:'Cedar Ridge', property_type:'rural', locality:'Elmshore', land_area:420000, zoning:'Rural (fictional)', sale_method:'private_sale', price_minor:240000000, price_label:'', status:'available', state:'published', image:'land-cedar-ridge',
        summary:'Forty-two hectares of grazing country with a ridge-top house site.',
        description:'Cedar Ridge is 42 hectares of undulating grazing land on Ridge Road, fenced into four paddocks with a dam in each. A cleared ridge-top site has views across the valley and power at the road. Two road frontages.\n\nRural zoning; a dwelling is permitted subject to approval. Offered for private sale. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-06', slug:'saltmere-valley-acreage', title:'Saltmere Valley Acreage', property_type:'rural', locality:'Saltmere', land_area:165000, zoning:'Rural living (fictional)', sale_method:'price_on_application', price_minor:0, price_label:'', status:'available', state:'published', image:'land-cedar-ridge',
        summary:'Sixteen and a half hectares of valley floor, ten minutes from the coast.',
        description:'Saltmere Valley Acreage is 16.5 hectares of mostly level valley floor on Valley Road, ten minutes by car from the coast at Saltmere. Established shelter belts, a seasonal creek and a fenced boundary. Rural-living zoning permits a dwelling subject to approval.\n\nPrice on application. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-07', slug:'orchard-lane-subdivision', title:'Orchard Lane Subdivision', property_type:'subdivision_investment', locality:'Fernwick', land_area:32000, zoning:'Residential growth (fictional)', sale_method:'tender', price_minor:0, price_label:'', status:'available', state:'published', image:'land-orchard-lane',
        summary:'An approved twelve-lot subdivision on the edge of town, offered by tender.',
        description:'Orchard Lane Subdivision is a 3.2 hectare parcel with approval for twelve residential lots of 1,800 to 3,200 m². Roads and services are designed and approved; construction has not started. Sold as one parcel with the approval in place.\n\nOffered by tender. This is a fictional listing with generated concept imagery.',
      ...
      { id:'demo-land-08', slug:'elmshore-heights-stage-2', title:'Elmshore Heights, Stage 2', property_type:'subdivision_investment', locality:'Elmshore', land_area:56000, zoning:'Urban growth (fictional)', sale_method:'expressions_of_interest', price_minor:0, price_label:'', status:'available', state:'draft', image:'land-elmshore-heights',
        summary:'The second stage of an established estate, fifteen lots with approval pending.',
        description:'Stage 2 of Elmshore Heights is a 5.6 hectare parcel beside the completed first stage, with a subdivision application for fifteen lots lodged and pending. Not yet published. This is a fictional listing with generated concept imagery.',
    ...
    const landCols = ['id','slug','title','mode','sector','property_type','price_minor','price_label','sale_method','currency','is_demo','bedrooms','bathrooms','parking','locality','summary','description','publication_state','transaction_status','media','features','details','highlights','floor_area','land_area','zoning','tenancy','featured','created_at','listed_at'];
    for (const f of landFixtures) {
      if (!one('SELECT id FROM properties WHERE id=?', f.id)) {
        ...
        run(`INSERT OR IGNORE INTO properties(${landCols.join(',')}) VALUES(${landCols.map(()=>'?').join(',')})`,
          ...
          JSON.stringify([{ url:`/assets/${f.image}.webp`, alt:`${f.title}: fictional land, generated concept study` }]), JSON.stringify(f.features), JSON.stringify(f.details), JSON.stringify(f.highlights),
          0, f.land_area, f.zoning, '', 0, createdAt, createdAt);
  ...
  for (const row of all("SELECT id,media,description FROM properties WHERE id LIKE 'demo-land-%' AND media LIKE '%illustrative site plan%'")) {
    ...
    run('UPDATE properties SET media=?, description=? WHERE id=?', JSON.stringify([{ url:`/assets/${image}.webp`, alt:`${title}: fictional land, generated concept study` }]), String(row.description).replace('This is a fictional listing with an illustrative site plan.','This is a fictional listing with generated concept imagery.'), row.id);
  }
